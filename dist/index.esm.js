...
var Container$4 = styled.div(templateObject_2$s || (templateObject_2$s = __makeTemplateObject(["\n  position: relative;\n  &:hover ", ", &:focus-within ", " {\n    display: flex;\n  }\n"], ["\n  position: relative;\n  &:hover ", ", &:focus-within ", " {\n    display: flex;\n  }\n"])), DropdownContent, DropdownContent);
...
var StyledBunnyPlaceholder = styled(Icon$1E)(templateObject_2$p || (templateObject_2$p = __makeTemplateObject(["\n  height: 100%;\n  width: 100%;\n"], ["\n  height: 100%;\n  width: 100%;\n"])));
...
var StyledLink$2 = styled(Text)(templateObject_1$D || (templateObject_1$D = __makeTemplateObject(["\n  display: flex;\n  align-items: center;\n  width: fit-content;\n  &:hover {\n    text-decoration: underline;\n  }\n"], ["\n  display: flex;\n  align-items: center;\n  width: fit-content;\n  &:hover {\n    text-decoration: underline;\n  }\n"])));
...
var Container$3 = styled.div(templateObject_3$a || (templateObject_3$a = __makeTemplateObject(["\n  position: relative;\n"], ["\n  position: relative;\n"])));
var RotatingPancakeIcon = styled(Icon$h)(templateObject_4$5 || (templateObject_4$5 = __makeTemplateObject(["\n  position: absolute;\n  top: 0;\n  left: 0;\n  animation: ", " 2s linear infinite;\n  transform: translate3d(0, 0, 0);\n"], ["\n  position: absolute;\n  top: 0;\n  left: 0;\n  animation: ", " 2s linear infinite;\n  transform: translate3d(0, 0, 0);\n"])), rotate);
...
var SubMenuContainer = styled.div(templateObject_1$q || (templateObject_1$q = __makeTemplateObject(["\n  display: flex;\n  flex-direction: column;\n  overflow: hidden;\n  min-width: 136px;\n  background: ", ";\n  border-radius: ", ";\n  border: ", ";\n"], ["\n  display: flex;\n  flex-direction: column;\n  overflow: hidden;\n  min-width: 136px;\n  background: ", ";\n  border-radius: ", ";\n  border: ", ";\n"])), function (_a) {
    var theme = _a.theme;
    return theme.colors.input;
}, function (_a) {
    var theme = _a.theme;
...
var ClickableElementContainer = styled.div(templateObject_2$g || (templateObject_2$g = __makeTemplateObject(["\n  cursor: pointer;\n"], ["\n  cursor: pointer;\n"])));
...
var Logo$4 = React.memo(Logo$3, function (prev, next) { return prev.isDark === next.isDark; });
...
var blink$1 = keyframes(templateObject_1$f || (templateObject_1$f = __makeTemplateObject(["\n  0%,  100% { transform: scaleY(1); } \n  50% { transform:  scaleY(0.1); } \n"], ["\n  0%,  100% { transform: scaleY(1); } \n  50% { transform:  scaleY(0.1); } \n"])));
var StyledLink$1 = styled(Link$1)(templateObject_2$a || (templateObject_2$a = __makeTemplateObject(["\n  display: flex;\n  align-items: center;\n  .mobile-icon {\n    width: 32px;\n    ", " {\n      display: none;\n    }\n  }\n  .desktop-icon {\n    width: 160px;\n    display: none;\n    ", " {\n      display: block;\n    }\n  }\n  .right-eye {\n    animation-delay: 20ms;\n  }\n  &:hover {\n    .left-eye,\n    .right-eye {\n      transform-origin: center 60%;\n      animation-name: ", ";\n      animation-duration: 350ms;\n      animation-iteration-count: 1;\n    }\n  }\n"], ["\n  display: flex;\n  align-items: center;\n  .mobile-icon {\n    width: 32px;\n    ", " {\n      display: none;\n    }\n  }\n  .desktop-icon {\n    width: 160px;\n    display: none;\n    ", " {\n      display: block;\n    }\n  }\n  .right-eye {\n    animation-delay: 20ms;\n  }\n  &:hover {\n    .left-eye,\n    .right-eye {\n      transform-origin: center 60%;\n      animation-name: ", ";\n      animation-duration: 350ms;\n      animation-iteration-count: 1;\n    }\n  }\n"])), function (_a) {
    var theme = _a.theme;
...
var LogoImage$1 = styled.img(templateObject_3$5 || (templateObject_3$5 = __makeTemplateObject(["\n  height: 64px;\n"], ["\n  height: 64px;\n"])));
var HeaderMenuButton = styled(MenuButton)(templateObject_4$2 || (templateObject_4$2 = __makeTemplateObject(["\n  margin: auto;\n"], ["\n  margin: auto;\n"])));
var Logo$2 = function (_a) {
    var isPushed = _a.isPushed; _a.isDark; var href = _a.href, togglePush = _a.togglePush;
    var isAbsoluteUrl = href.startsWith("http");
    return (React.createElement(Flex, null,
        React.createElement(HeaderMenuButton, { "aria-label": "Toggle menu", onClick: togglePush, mr: "24px" }, isPushed ? (React.createElement(Icon$d, { width: "24px", color: "textSubtle" })) : (React.createElement(Icon$e, { width: "24px", color: "textSubtle" }))),
        isAbsoluteUrl ? (React.createElement(StyledLink$1, { as: "a", href: href, "aria-label": "home page" },
            React.createElement(LogoImage$1, { src: "./images/Logo.png" }))) : (React.createElement(StyledLink$1, { to: href, "aria-label": "home page" },
            React.createElement(LogoImage$1, { src: "./images/Logo.png" })))));
};
var HeaderLogo = React.memo(Logo$2, function (prev, next) { return prev.isPushed === next.isPushed && prev.isDark === next.isDark; });
...
var PanelBody = function (_a) {
    ...
    return (React.createElement(Container$1, null, links.map(function (entry) {
        var iconElement = React.createElement("img", { src: entry.icon, width: "40px" });
...
var BubbleIcon = styled.img(templateObject_2$7 || (templateObject_2$7 = __makeTemplateObject(["\n  width: 24px;\n  margin-right: 8px;\n"], ["\n  width: 24px;\n  margin-right: 8px;\n"])));
var CakePrice = function (_a) {
    var cakePriceUsd = _a.cakePriceUsd;
    return cakePriceUsd ? (React.createElement(PriceLink, { href: "/", target: "_blank" },
        React.createElement(BubbleIcon, { src: '/images/bubblelogo.png' }),
...
var Container = styled.div(templateObject_1$a || (templateObject_1$a = __makeTemplateObject(["\n  flex: none;\n  padding: 8px 4px;\n  background-color: 'transparent';\n  border-top: 2px solid rgb(50, 50, 50, 0.5);\n"], ["\n  flex: none;\n  padding: 8px 4px;\n  background-color: 'transparent';\n  border-top: 2px solid rgb(50, 50, 50, 0.5);\n"])));
var SettingsEntry = styled.div(templateObject_2$6 || (templateObject_2$6 = __makeTemplateObject(["\n  display: flex;\n  align-items: center;\n  justify-content: space-between;\n  height: ", "px;\n  padding: 0 8px;\n"], ["\n  display: flex;\n  align-items: center;\n  justify-content: space-between;\n  height: ", "px;\n  padding: 0 8px;\n"])), MENU_ENTRY_HEIGHT);
var SocialEntry = styled.div(templateObject_3$3 || (templateObject_3$3 = __makeTemplateObject(["\n  display: flex;\n  align-items: center;\n  justify-content: space-between;\n  height: ", "px;\n  padding: 0 16px;\n"], ["\n  display: flex;\n  align-items: center;\n  justify-content: space-between;\n  height: ", "px;\n  padding: 0 16px;\n"])), MENU_ENTRY_HEIGHT);
...
var LogoImage = styled.img(templateObject_3$2 || (templateObject_3$2 = __makeTemplateObject(["\n  width: 100%;\n"], ["\n  width: 100%;\n"])));
var Logo = function (_a) {
    _a.isPushed; _a.isDark; var href = _a.href;
    var isAbsoluteUrl = href.startsWith("http");
    return (React.createElement(Flex, null, isAbsoluteUrl ? (React.createElement(StyledLink, { as: "a", href: href, "aria-label": "home page" },
        React.createElement(LogoImage, { src: "./images/Logo.png" }))) : (React.createElement(StyledLink, { to: href, "aria-label": "home page" },
        React.createElement(LogoImage, { src: "./images/Logo.png" })))));
};
...
var Panel = function (props) {
    ...
    return (React.createElement(StyledPanel, { isPushed: isPushed, showMenu: isMobile },
        isMobile ? null : (React.createElement(Logo$1, { isPushed: isPushed, isDark: isDark, href: (_a = homeLink === null || homeLink === void 0 ? void 0 : homeLink.href) !== null && _a !== void 0 ? _a : "/" })),
    ...
    return (React.createElement(Wrapper, null,
        isSmallerScreen ?
            (React.createElement(StyledNav, { showMenu: showMenu },
                React.createElement(HeaderLogo, { isPushed: isPushed, isDark: isDark, href: (_b = homeLink === null || homeLink === void 0 ? void 0 : homeLink.href) !== null && _b !== void 0 ? _b : "/", togglePush: function () { return setIsPushed(function (prevState) { return !prevState; }); } }),
                React.createElement(Flex, null,
                    globalMenu,
                    " ",
                    userMenu))) : null,
        React.createElement(BodyWrapper, null,
            React.createElement(Panel, { isPushed: isPushed, isMobile: isSmallerScreen, showMenu: showMenu, isDark: isDark, toggleTheme: toggleTheme, langs: langs, setLang: setLang, currentLang: currentLang, cakePriceUsd: cakePriceUsd, pushNav: setIsPushed, links: links, homeLink: homeLink, togglePush: function () { return setIsPushed(function (prevState) { return !prevState; }); } }),
            React.createElement(Inner, { isPushed: isPushed, showMenu: isSmallerScreen }, children),
